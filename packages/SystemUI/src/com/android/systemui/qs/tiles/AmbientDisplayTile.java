...
public class AmbientDisplayTile extends QSTileImpl<BooleanState> {
    ...
    public AmbientDisplayTile(
        ...
        mSetting = new SecureSetting(secureSettings, mHandler, Settings.Secure.DOZE_ENABLED) {
            @Override
    ...
    public boolean isAvailable() {
        final AmbientDisplayConfiguration config = new AmbientDisplayConfiguration(mContext);
        return config.pulseOnNotificationAvailable();
    }
