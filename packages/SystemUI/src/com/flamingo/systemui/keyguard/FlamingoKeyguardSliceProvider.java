package com.flamingo.systemui.keyguard;
...
public class FlamingoKeyguardSliceProvider extends KeyguardSliceProvider implements SmartSpaceUpdateListener {
    private static final String TAG = "FlamingoKeyguardSliceProvider";
    ...
    private static class AddShadowTask extends AsyncTask<Bitmap, Void, Bitmap> {
        ...
        private final WeakReference<FlamingoKeyguardSliceProvider> mProviderReference;
        private final SmartSpaceCard mWeatherCard;

        AddShadowTask(FlamingoKeyguardSliceProvider flamingoKeyguardSliceProvider, SmartSpaceCard smartSpaceCard) {
            this.mProviderReference = new WeakReference<>(flamingoKeyguardSliceProvider);
            this.mWeatherCard = smartSpaceCard;
            this.mBlurRadius = flamingoKeyguardSliceProvider.getContext().getResources().getDimension(R.dimen.smartspace_icon_shadow);
        }
        ...
        public void onPostExecute(Bitmap bitmap) {
            FlamingoKeyguardSliceProvider flamingoKeyguardSliceProvider;
            synchronized (this) {
                this.mWeatherCard.setIcon(bitmap);
                flamingoKeyguardSliceProvider = this.mProviderReference.get();
            }
            if (flamingoKeyguardSliceProvider != null) {
                flamingoKeyguardSliceProvider.notifyChange();
            }
        }
