...
public class FlamingoKeyguardSliceProvider extends KeyguardSliceProvider implements SmartSpaceUpdateListener {
    ...
    private static class AddShadowTask extends AsyncTask<Bitmap, Void, Bitmap> {
        ...
        AddShadowTask(FlamingoKeyguardSliceProvider keyguardSliceProvider, SmartSpaceCard smartSpaceCard) {
        ...
        public void onPostExecute(Bitmap bitmap) {
            FlamingoKeyguardSliceProvider keyguardSliceProvider;
            synchronized (this) {
                mWeatherCard.setIcon(bitmap);
                keyguardSliceProvider = (FlamingoKeyguardSliceProvider) mProviderReference.get();
            }
    ...
    public Slice onBindSlice(Uri uri) {
        Trace.beginSection("FlamingoKeyguardSliceProvider#onBindSlice");
        Slice slice;
